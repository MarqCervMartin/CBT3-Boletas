...
$sql = "SELECT concat(Nombres,' ',Paterno,' ',Materno)as nombre_completo from alumno where id_usuario='$idUsuario'";
...
<html lang="es">
<head>
    <title>Bienvenido <?php echo $row['nombre_completo']; ?> </title>
	<meta charset="UTF-8">
		...
		<div class="full-box dashboard-sideBar-ct">
			...
			<div class="full-box dashboard-sideBar-UserInfo">
				<figure class="full-box">
					...
					<figcaption class="text-center text-titles"><?php echo'Alumno: '. $row['nombre_completo']; ?></figcaption>
				</figure>
			...
			<ul class="list-unstyled full-box dashboard-sideBar-Menu">
				...
				<li>
					...
					<ul class="list-unstyled full-box">
						<li>
							<a href="period.html"><i class="zmdi zmdi-timer zmdi-hc-fw"></i>Activar Evaluaciones</a>
						</li>
						<li>
							<a href="subject.html"><i class="zmdi zmdi-book zmdi-hc-fw"></i>Asignar Materias</a>
						</li>
						<li>
							<a href="salon.html"><i class="zmdi zmdi-font zmdi-hc-fw"></i>Lista de Alumnos</a>
						</li>
					</ul>
				</li>
				<li>
					...
					<ul class="list-unstyled full-box">
						<li>
							<a href="#" onclick="mostrar('../Panel/subirAlumnos.php');"><i class="zmdi zmdi-male-alt zmdi-hc-fw"></i>Profesores</a>
						</li>
						<li>
