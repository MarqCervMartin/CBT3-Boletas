...
<html lang="es">
<head>
    <title>Bienvenido <?php echo $row['matricula']; ?> </title>
	<meta charset="UTF-8">

	<meta name="viewport" content="width=device-width, user-scalable=no, initial-scale=1.0, maximum-scale=1.0, minimum-scale=1.0">
        <link href="../Vista/Panel/css/main.css" rel="stylesheet" type="text/css"/>
        <link href="../Vista/Panel/css/style.css" rel="stylesheet" type="text/css"/>
...
<body>
		...
		<div class="full-box dashboard-sideBar-ct">
			...
			<div class="full-box dashboard-sideBar-UserInfo">
				<figure class="full-box">
					...
					<figcaption class="text-center text-titles">ADMINISTRADOR CBT 3</figcaption>
				</figure>
			...
			<ul class="list-unstyled full-box dashboard-sideBar-Menu">
					...
					<ul class="list-unstyled full-box">
						<li>
                                                    <a href="#" onclick="mostrar('../Vista/Panel/evaluacionActiv.php');"><i class="zmdi zmdi-timer zmdi-hc-fw"></i>Activar Evaluaciones</a>
						</li>
						<li>
							<a href="#" onclick="mostrar('../Vista/Panel/Asignmateria.php');"><i class="zmdi zmdi-book zmdi-hc-fw"></i>Asignar Materias</a>
						</li>
                                              
						<li>
							<a href="#" onclick="mostrar('../Vista/Panel/consulAlumn.php');"><i class="zmdi zmdi-font zmdi-hc-fw"></i>Inscribir Alumnos</a>
						</li>
					</ul>
				</li>
				<li>
					...
					<ul class="list-unstyled full-box">
						<li>
							<a href="#" onclick="mostrar('../Vista/Panel/subirProfesor.php');"><i class="zmdi zmdi-male-alt zmdi-hc-fw"></i>Profesores</a>
						</li>
						<li>
                                                    
                                                    <a href="#" onclick="mostrar('../Vista/Panel/subirAlumnos.php');"><i class="zmdi zmdi-face zmdi-hc-fw"></i> Alumnos</a>
						</li>
						
                                                <li>
							<a href="#"onclick="mostrar('../Vista/Panel/subirMaterias.php');"><i class="zmdi zmdi-calendar-note zmdi-hc-fw"></i>Materias </a>
	...
	<section class="full-box dashboard-contentPage">
		...
		<div class="container-fluid">
			<div class="page-header">
			  <h1 class="text-titles">Bienvenido  <small>Administrador</small></h1>
			</div>
		</div>
  ...
  $(document).ready(function (){
      $('#calendariouweb').fullCalendar();
                ...
                <div class="container-fluid" id="muestras">
			<div class="page-header">
			  <h1 class="text-titles">Agenda <small>del dia</small></h1>
			</div>
			<section id="cd-timeline" class="cd-container">
                <div class="cd-timeline-block">
                    <div class="cd-timeline-img">
                        <img src="../Imagenes/logo.jpg" alt="user-picture">
